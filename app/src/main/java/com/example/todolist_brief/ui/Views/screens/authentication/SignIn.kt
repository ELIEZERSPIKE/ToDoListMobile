        ...
        Scaffold(
            ...
            Column(
                ...
                Column (
                    ...
                    Text(text = stringResource(id = R.string.signing_in_text),
                        color = MaterialTheme.colorScheme.onBackground,
                    ...
                    Column(
                        ...
                        Text(text = stringResource(id = R.string.forgotten_password),
                            style = MaterialTheme.typography.bodyMedium,
                    ...
                    Button(onClick = { },
                        shape = RoundedCornerShape(dimensionResource(id = R.dimen.dp_3)),
                        modifier = Modifier
                            .fillMaxWidth()
                    ) {
                        Text(text = stringResource(id = R.string.sign_in))
                    ...
                    Row(
                        ...
                        Text(text = stringResource(id = R.string.not_yet_registred),
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.primary,
                            fontWeight = FontWeight.Bold,
                            modifier = Modifier
